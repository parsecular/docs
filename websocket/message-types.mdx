---
title: "Message Types"
description: "Orderbook snapshots, deltas, activity events, wallet activity, and connection-level WebSocket messages."
---
...
Wallet subscriptions emit `type: "wallet_activity"` and always carry a full
replacement snapshot for one `(exchange, address)` pair.
...
<ResponseField name="address" type="string">
  Public wallet address being watched.
</ResponseField>

<ResponseField name="data" type="object">
  Raw exchange-specific wallet activity snapshot.
</ResponseField>

<ResponseField name="server_seq" type="number">
  Monotonic sequence number for this address subscription.
</ResponseField>

<ResponseField name="ingest_ts_ms" type="number">
  Server ingest timestamp in milliseconds.
</ResponseField>
