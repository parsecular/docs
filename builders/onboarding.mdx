...
An admin will schedule a **30-minute call** to:

1. Understand your use case and technical requirements
2. Walk through the Builder API and fee escrow setup
3. Provision your builder account (`account_type: "builder"`)
4. Set your initial QPS pool allocation and tier
...
| **Builder tier** | Starting at Bronze |
...
resp = requests.post(
    ...
    json={"external_id": "user_001", "email": "alice@example.com"},
)
user = resp.json()
