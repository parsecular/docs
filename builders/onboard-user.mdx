---
title: "Onboard User"
description: "Onboard an end-user to an exchange."
---
...
const result = await client.builder.onboard.create({
  customer_id: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  exchange: 'polymarket',
  mode: 'managed',
});
console.log(result.status, result.linked_exchanges);
```
```python Python
result = client.builder.onboard.create(
    customer_id="a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    exchange="polymarket",
    mode="managed",
)
print(result.status, result.linked_exchanges)
```
</RequestExample>
