...
1. Start with [Onboarding](/builders/onboarding) to get a builder key and fee settings.
2. Read [Authentication](/builders/authentication) so your backend sends impersonated requests correctly.
3. Create the end-user with [Create User](/builders/create-user).
4. Link the user to an exchange with [Onboard User](/builders/onboard-user).
5. Place and monitor orders with [Order Routing](/builders/order-routing).
6. Add revenue controls later with [Fee Escrow](/builders/fee-escrow) and [Tracking](/builders/tracking).
