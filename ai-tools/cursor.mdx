...
<CardGroup cols={2}>
<Card title="Authentication" icon="key" href="/configuration/overview">
  Learn how to authenticate requests using API keys.
</Card>

<Card title="Error handling" icon="circle-exclamation" href="/errors/overview">
  Understand error codes and best practices for handling failures.
</Card>
</CardGroup>
