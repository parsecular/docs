...
<ParamField body="params" type="object">
  ...
  |-----|--------|-------------|
  | `order_type` | `limit` (default), `ioc` | Order type. `ioc` (Immediate-or-Cancel) fills what it can and cancels the rest. |
</ParamField>
...
curl -X POST \
  ...
  "https://api.parsecular.com/api/v1/orders?exchange=polymarket"
