...
Places a new limit order on the specified exchange.
...
<ParamField body="params" type="object">
  Exchange-specific parameters. For Polymarket, use `token_id` to specify the outcome token and `order_type` (`GTC`, `FOK`, `IOC`).
</ParamField>
...
curl -X POST \
  ...
  "http://localhost:3000/api/v1/orders?exchange=polymarket"
```
</RequestExample>
