...
description: "Merge YES/NO outcome tokens back into USDC via gasless relayer"
---
...
<Info>
  ...
  to relay the on-chain CTF `mergePositions` call. The caller must be authenticated
...
<ParamField body="condition_id" type="string" required>
  The condition ID (bytes32 hex) identifying the market condition to merge.
  Example: `"0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"`
</ParamField>

<ParamField body="amount" type="string" required>
  USDC amount in smallest unit (6 decimals). For example, `"1000000"` = 1 USDC.
  You must hold at least this amount of both YES and NO tokens.
</ParamField>
