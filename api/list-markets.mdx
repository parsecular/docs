  ...
  <Expandable title="properties">
    <ResponseField name="markets" type="Market[]">
      ...
      <Expandable title="Market properties">
        ...
        <ResponseField name="rules" type="string | null">
          Resolution rules.
        </ResponseField>
        ...
        <ResponseField name="outcome_count" type="number | null">
          Number of outcomes.
        </ResponseField>
        ...
        <ResponseField name="best_bid" type="number | null">
          Best bid price.
        </ResponseField>
        <ResponseField name="best_ask" type="number | null">
          Best ask price.
        </ResponseField>
        <ResponseField name="last_price" type="number | null">
          Last traded price.
        </ResponseField>
        <ResponseField name="volume_total" type="number">
          Total lifetime volume.
        </ResponseField>
        <ResponseField name="volume_24h" type="number | null">
          24-hour trading volume.
        </ResponseField>
        <ResponseField name="liquidity" type="number | null">
          Current liquidity.
        </ResponseField>
        <ResponseField name="open_interest" type="number | null">
        ...
        <ResponseField name="event_start_time" type="string | null">
          ISO 8601 event start time.
        </ResponseField>
        <ResponseField name="condition_id" type="string | null">
          Condition ID for CTF markets.
        </ResponseField>
        <ResponseField name="xref" type="object | null">
          Cross-reference data (exchange-specific metadata).
        </ResponseField>
        <ResponseField name="collection_date" type="string | null">
          ISO 8601 date when this record was collected.
        </ResponseField>
        <ResponseField name="last_collected" type="string | null">
