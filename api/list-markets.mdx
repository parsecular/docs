...
Returns a paginated array of markets from the DuckDB gold layer with filtering and pagination.
...
curl -H "X-API-Key: YOUR_API_KEY" \
  "https://api.parsecapi.com/api/v1/markets?parsec_ids=polymarket:572473,kalshi:KXPRESPERSON-28-GNEWS"
```
</RequestExample>
