---
title: "Get Usage"
description: "Inspect your current tier limits and in-period REST and WebSocket usage."
---
...
<ResponseField name="limits" type="object">
  ...
  <Expandable title="properties">
    <ResponseField name="monthly_requests" type="integer">
      Monthly REST request cap. `0` means unlimited.
    </ResponseField>
...
<Tip>
Use [`/api/v1/ws/usage`](/api/ws-usage) when you need the more detailed
